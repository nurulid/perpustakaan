    ...
    <div class="container" style="margin-bottom: 20px;">
        ...
        <form method="POST" action="<?php $_SERVER['PHP_SELF']; ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama" id="nama" class="form-control" placeholder="Nama Siswa" readonly>
            </div>
            <div class="form-group">
                <label>ID Buku</label>
            ...
            <div class="form-group">
                ...
                <input type="text" name="judul" id="judul" class="form-control" placeholder="Judul Buku" readonly>
            </div>
            <div class="form-group">
                ...
                <input type="text" name="tgl_pinjam_muncul" class="form-control" value="<?php echo date('d M Y', $_pinjam) ;?>" readonly>
            </div>
            <div class="form-group">
