    ...
    <div class="container" style="margin-bottom: 20px;">
        ...
        <form method="POST" action="<?php $_SERVER['PHP_SELF']; ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" name="tgl_pinjam_muncul" class="form-control" value="<?php echo date('d M Y', $_pinjam) ?>">
            </div>
            <div class="form-group">
                ...
                <input type="text" name="tgl_kembali_muncul" class="form-control" value="<?php echo date('d M Y', $_kembali) ?>">
            </div>
